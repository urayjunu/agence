...
&nbsp;&nbsp;</td><form action="con_desempenho.htm">
                  ...
                  <tr bgcolor="#fafafa">
                    ...
                    <td><table align="center">
                        <tr>
                          ...
                          <td>
                            <select multiple size="8" name="list2" id="list2" style="   width:280">
                              @foreach($list2 as $k => $v)
                                <option value="{{ $v['co_usuario'] }}" >{{ $v['no_usuario']}}</option>
                              @endforeach
                            </select>
              ...
              @foreach($list2 as $k => $v)
                    <table cellspacing=1 cellpadding=3 width="100%" 
                      ...
                      <tbody>
                        <tr bgcolor=#efefef>
                          <td colspan=5><span class="style3">{{ $v['co_usuario'] }} </span> </td>
                        </tr>
                        <tr bgcolor=#fafafa>
                      ...
                      @foreach($receita_liquida as $vreceita)
                        @if($vreceita['co_usuario'] == $v['co_usuario'] ) 
                          <tr bgcolor=#fafafa>
                            <td nowrap>{{ $vreceita['data_emissao'] }} </td>
                            <td><div align="right">R$ {{ $vreceita['receita_liquida'] }} </div></td>
                            <td><div align="right">- R$ 0.000,00</div></td>
                            <td><div align="right">- R$ 0.000,00</div></td>
